...
OPENAI_SOCIAL_IMAGE_MODEL = env('OPENAI_SOCIAL_IMAGE_MODEL', '')
OPENAI_SOCIAL_IMAGE_QUALITY = env('OPENAI_SOCIAL_IMAGE_QUALITY', 'standard')
OPENAI_SOCIAL_VISION_MODEL = env('OPENAI_SOCIAL_VISION_MODEL', env('OPENAI_SOCIAL_MODEL', ''))
...
SOCIAL_MEDIA_MATCH_MIN_SCORE = float(env('SOCIAL_MEDIA_MATCH_MIN_SCORE', '45'))
SOCIAL_IMAGE_ANALYSIS_MIN_CONFIDENCE = float(env('SOCIAL_IMAGE_ANALYSIS_MIN_CONFIDENCE', '0.62'))
SOCIAL_AI_IMAGE_MAX_PER_TICK = int(env('SOCIAL_AI_IMAGE_MAX_PER_TICK', '2'))
SOCIAL_AI_IMAGE_MAX_PER_PROFILE_PER_DAY = int(env('SOCIAL_AI_IMAGE_MAX_PER_PROFILE_PER_DAY', '5'))
SOCIAL_AI_IMAGE_MAX_BYTES = int(env('SOCIAL_AI_IMAGE_MAX_BYTES', '8000000'))
SOCIAL_AI_COMPOSED_SLIDE_MAX_ATTEMPTS = int(env('SOCIAL_AI_COMPOSED_SLIDE_MAX_ATTEMPTS', '2'))
SOCIAL_AI_COMPOSED_MAX_CALLS_PER_CAROUSEL = int(env('SOCIAL_AI_COMPOSED_MAX_CALLS_PER_CAROUSEL', '8'))
...
SOCIAL_INSTAGRAM_TOKEN_ENCRYPTION_KEY = env('SOCIAL_INSTAGRAM_TOKEN_ENCRYPTION_KEY', '')
SOCIAL_INSTAGRAM_LEGACY_FALLBACK = env('SOCIAL_INSTAGRAM_LEGACY_FALLBACK', 'true').lower() in {'1', 'true', 'yes', 'on'}
SOCIAL_INSTAGRAM_CLIENT_ID = env('SOCIAL_INSTAGRAM_CLIENT_ID', '')
SOCIAL_INSTAGRAM_CLIENT_SECRET = env('SOCIAL_INSTAGRAM_CLIENT_SECRET', '')
SOCIAL_INSTAGRAM_OAUTH_REDIRECT_URI = env('SOCIAL_INSTAGRAM_OAUTH_REDIRECT_URI', '')
SOCIAL_INSTAGRAM_OAUTH_SCOPES = env('SOCIAL_INSTAGRAM_OAUTH_SCOPES', 'instagram_business_basic,instagram_business_content_publish')
...
SOCIAL_AUTOMATION_MAX_CAROUSELS_PER_TICK = int(env('SOCIAL_AUTOMATION_MAX_CAROUSELS_PER_TICK', '1'))

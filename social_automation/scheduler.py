...
def estoque_pronto(profile: SocialProfile):
    return profile.contents.filter(
        ...
        final_image__isnull=False,
    ).exclude(final_image='').count()

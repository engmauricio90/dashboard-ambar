...
urlpatterns = [
    ...
    path('conteudos/<int:content_id>/reconciliar-publicacao/', views.content_reconcile_publish, name='content_reconcile_publish'),
    path('conteudos/<int:content_id>/confirmar-nao-publicado/', views.content_confirm_not_published, name='content_confirm_not_published'),

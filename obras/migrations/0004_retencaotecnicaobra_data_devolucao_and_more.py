...
def carregar_ipanema(apps, schema_editor):
    ...
    obra = Obra.objects.filter(nome_obra__iexact='IPANEMA').first()
    if obra is None:
        return
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='retencaotecnicaobra',
            name='data_devolucao',
        ...
        migrations.AddField(
            model_name='retencaotecnicaobra',
            name='tipo',
            field=models.CharField(choices=[('retencao', 'Retencao'), ('devolucao', 'Devolucao')], default='retencao', max_length=20),
        ),
